...
public class EditTripActivity extends AppCompatActivity {
    ...
    private RecyclerView updateItineraryRecyclerView;
    private ItineraryAdapter updateItineraryAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonAddLocation = findViewById(R.id.updateButtonAddLocation);

        updateItineraryRecyclerView = findViewById(R.id.itineraryRecyclerView);

        updateItineraryAdapter = new ItineraryAdapter( itineraryItems, () -> {
            buttonAddLocation.setVisibility(View.INVISIBLE);
            buttonAddLocation.callOnClick();
            updateItineraryAdapter.notifyDataSetChanged();
        });

        LinearLayoutManager layoutManagerItinerary = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        updateItineraryRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        updateItineraryRecyclerView.setAdapter(updateItineraryAdapter);
        updateItineraryRecyclerView.addItemDecoration(new ConnectingLineItemDecoration(Color.GRAY, 5));
        ...
        itineraryItems = (ArrayList<String>) getIntent().getSerializableExtra("itineraryItems");
