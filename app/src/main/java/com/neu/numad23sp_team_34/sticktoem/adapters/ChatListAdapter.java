...
public class ChatListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ChatListAdapter(Context context, List<Message> messages, String senderName, String receiverName) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            case SENDER_VIEW_HOLDER:
                ...
                chatSenderViewHolder.message.setText(messageList.get(position).getStickerId());
                break;

            case RECEIVER_VIEW_HOLDER:
                ChatReceiverViewHolder chatReceiverViewHolder = (ChatReceiverViewHolder) holder;
                chatReceiverViewHolder.message.setText(messageList.get(position).getStickerId());
                break;
        }
    }
    ...
    public static class ChatReceiverViewHolder extends RecyclerView.ViewHolder {
        ...
        public ChatReceiverViewHolder(@NonNull View itemView) {
            super(itemView);
            message = itemView.findViewById(R.id.receiverMessage);
        }
